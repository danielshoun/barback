...
class OrganizationController {
    ...
    fun addOrganization(@RequestBody addOrganizationForm: AddOrganizationForm,
    ...
    fun joinOrganization(@RequestBody joinOrganizationForm: JoinOrganizationForm,
                         @CookieValue(value = "session") session: String): ResponseEntity<String> {
    ...
    fun approveUser(@PathVariable(name = "organizationId") organizationId: Long,
    ...
    fun getOrganization(@PathVariable(name = "organizationId") organizationId: Long,
                        @CookieValue(value = "session") session: String): ResponseEntity<Organization> {
        return organizationService.getOrganization(organizationId, session)
    }

    @GetMapping("/api/v1/organization/{organizationId}/users")
    fun getOrgUsers(@PathVariable(name = "organizationId") organizationId: Long,
                    @CookieValue(value = "session") session: String): ResponseEntity<MutableList<User>> {
    ...
    fun getUnapprovedUsers(@PathVariable(name = "organizationId") organizationId: Long,
                           @CookieValue(value = "session") session: String): ResponseEntity<MutableList<User>> {
    ...
    fun addEventCategory(@PathVariable(name = "organizationId") organizationId: Long,
